...
export function NotificationsPanel() {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const res = await fetch(`https://backend.votly.app/surveys/notification_settings/${formId}`);
  ...
  const saveSettings = async () => {
    try {
      await fetch(`https://backend.votly.app/surveys/notification_settings/${formId}`, {
        method: 'PUT',
