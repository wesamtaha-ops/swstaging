      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex items-center px-4 py-2 border border-l-0 border-transparent rounded-r-md bg-indigo-600 text-sm font-almarai text-white hover:bg-indigo-700"
            >
