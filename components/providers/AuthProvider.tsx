...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  //   try {
  //     setIsLoading(true);
  //     const response = await fetch("https://backend.votly.app/user/login", {
  //       method: "POST",
  //       headers: {
  ...
  const logout = async () => {
    try {
      ...
      await fetch("https://backend.votly.app/user/logout", {
        method: "POST",
        credentials: "include",
      });
  ...
  const checkAuth = async () => {
    try {
      ...
      const response = await fetch("https://backend.votly.app/user/authenticated", {
        method: "GET",
        credentials: "include",
      });
      ...
      if (refreshResponse.ok) {
        ...
        const retryResponse = await fetch(
          "https://backend.votly.app/user/authenticated",
          {
            method: "GET",
            credentials: "include",
          }
